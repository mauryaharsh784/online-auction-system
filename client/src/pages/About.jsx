        ...
        <div className="bg-white rounded-sm shadow-sm p-8">
          ...
          <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
            ...
            <section>
              ...
              <p>
                This project has been created by <strong>Harsh Vardhan Maurya</strong>{" "}
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-sm">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <a
                      href="https://github.com/mauryaharsh784"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                      github.com/mauryaharsh784
                    </a>
                  </p>
                  <p>
                    <span className="font-medium">Project Repository:</span>{" "}
                    <a
                      href="https://github.com/mauryaharsh784/online-auction-system"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline"
                    >
                      github.com/mauryaharsh784/online-auction-system
                    </a>
                  </p>
                </div>
              </div>
